...
AccountTokenData _$AccountTokenDataFromJson(Map<String, dynamic> json) =>
    AccountTokenData(
      ...
      lastDownvoteTime: AccountTokenData.fromUTCDateTime(
          json['last_downvote_time'] as String),
      ...
      lastVoteTime:
          AccountTokenData.fromUTCDateTime(json['last_vote_time'] as String),
...
Map<String, dynamic> _$AccountTokenDataToJson(AccountTokenData instance) =>
    <String, dynamic>{
      ...
      'last_downvote_time':
          AccountTokenData.toUTCDateTime(instance.lastDownvoteTime),
      ...
      'last_vote_time': AccountTokenData.toUTCDateTime(instance.lastVoteTime),
